/* proc.h - isbadpid */
//Added two entries in the process entry table for foodness and quantum
#ifndef _PROC_H_
#define _PROC_H_
...
struct	pentry	{
	...
	int	pwaitret;	
	int 	goodness;		/*for classOfScheduler == linuxsched*/
	int 	quantum;
	int 	counter;		/*for classOfSCheduler == linuxsched*/
};
